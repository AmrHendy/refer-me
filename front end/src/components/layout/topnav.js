  ...
  render() {
    ...
    return (
      <div className="w3-row w3-teal nav-wrapper">
          ...
          <div className="w3-row">
            <div className="w3-col image-wrapper">
              <img
                ...
                src={imagePath || "http://localhost:8000/profile.png"}
              />
            </div>
            <div className="w3-col name-wrapper">
              <span className="mine name-style" onClick={this.redirectProfile}>
                {" "}
                {firstName} {lastName}
              </span>
            </div>
        ...
        <div
          className="w3-col w3-xxlarge sh-topnav-title-container"
          onClick={this.redirectHome}>
          ReferME
        </div>

        <div className="w3-col w3-right signout-wrapper">
          <span className="mine name-style" onClick={this.redirectSignout}>
            Signout
          </span>
        </div>

        <div className="w3-col w3-right request-wrapper">
          <span className="mine name-style" onClick={this.redirectRequests}>
            Requests
          </span>
          <span className="w3-yellow w3-small mine comp__11">
            {requestNum || "0"}
          </span>
        </div>
        <div className="w3-col w3-right comp22">
          <span className="mine name-style" onClick={this.redirectHome}>
            Home
          </span>
        </div>
      </div>
