    ...
    return (
      <div id="request_modal" className="w3-modal">
        <div className="w3-modal-content w3-animate-zoom w3-card-12 comp1">
          <div className="w3-container w3-teal w3-padding-16 comp2">
              Request Refer
          </div>

          <div className="w3-container comp11">
            <div className="comp6">
              <label className="w3-text-grey"><b>Position</b></label>
              <input type="text" className="w3-input w3-border comp13"
                placeholder="position name" name="position" value={this.state.position}/>
            </div>
            
            <div className="comp6">
              <label className="w3-text-grey"><b>Message</b></label>
              <textarea className="w3-input w3-border comp12 comp13" name="message">
                {this.state.message}
              </textarea>
            </div>
          </div>
