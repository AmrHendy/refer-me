      ...
      <div className="w3-border w3-round-large profileCard-comp1">
        ...
        <div className="w3- profileCard-comp5">
          <div className="w3-row profileCard-comp6">
            <div className="w3-col profileCard-comp7">First Name</div>
          ...
          <div className="w3-row profileCard-comp6">
            <div className="w3-col profileCard-comp7">Last Name</div>
          ...
          <div className="w3-row profileCard-comp6">
            <div className="w3-col profileCard-comp7">Email</div>
          ...
          <div className="w3-row profileCard-comp6">
            <div className="w3-col profileCard-comp7">Password</div>
          ...
          <div className="w3-row profileCard-comp6">
            <div className="w3-col profileCard-comp7">Resume</div>
          ...
          <div className="w3-row profileCard-comp6 update-btn">
            <div className="w3-col profileCard-comp9">
              <button className="w3-btn w3-indigo" onClick={this.handleUpdate}>
                Update Info
              </button>
            </div>
          </div>
